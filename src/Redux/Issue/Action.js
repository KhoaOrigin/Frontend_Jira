...
export const getIssueByProjectId = (projectId) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type: actionType.FETCH_ISSUES_BY_PROJECT_ID_SUCCESS, issue: data.data})
    } catch(error) {
...
export const getIssueById = (issueId) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type: actionType.FETCH_ISSUE_BY_ID_SUCCESS, issue: data.data})
    } catch(error) {
        console.log("error", error)
...
export const updateIssueStatus = (issueId, status) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type: actionType.UPDATE_ISSUE_STATUS_SUCCESS, issue: data.data})
    } catch(error) {
        console.log("error", error)
...
export const createIssue = (issueData) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({type: actionType.CREATE_ISSUE_SUCCESS, issue: data.data})
    } catch(error) {
        console.log("error", error)
